...
.. list-table::
   ...
   * - .. image:: sdc-le-01d/images/sdc-le-01d-img1.png
         :width: 200
         :alt: SDC-LE-01D 模组正面图
     - .. image:: sdc-le-01d/images/sdc-le-01d-img2.png
         :width: 200
         :alt: SDC-LE-01D 模组反面图

.. image:: sdc-le-01d/images/sdc-le-01d-img3.png
   :width: 500
   :align: center
...
- **SRRC**：符合中国无线电管理委员会标准，通过SRRC认证
  - 下载链接：`SRRC证书 <../certificates/sdc-le-01d-srrc.pdf>`_
- **FCC**：符合美国联邦通信委员会标准，通过FCC认证
  - 下载链接：`FCC证书 <../certificates/sdc-le-01d-fcc.pdf>`_
- **BQB**：符合蓝牙技术联盟标准，通过BQB认证
  - 下载链接：`BQB证书 <../certificates/sdc-le-01d-bqb.pdf>`_